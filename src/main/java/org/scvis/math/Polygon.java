 ...
 */
public class Polygon implements Border2D<Polygon> {
    ...
    /**
     * Checks whether a given vector is inside or outside a simple polygon using the Jordan test.
     * <p>
     * This method counts the number of intersections for a ray passing from the exterior of the polygon to any point:
     * If odd, it shows that the point lies inside the polygon; if even, the point lies outside the polygon.
     *
    ...
    /**
     * Checks if a ray passing from the exterior of the polygon crosses a line AB of the polygon.
     *
    ...
    @Override
    public boolean intersects(@Nonnull Polygon poly) {
