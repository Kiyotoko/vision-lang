...
public class Point2D implements Serializable {
    ...
    /**
     * Subtracts the given x and y coordinates from this vector and returns a new Vector2D object.
     *
    ...
    /**
     * Calculates the distance between this vector and the vector with the given x and y coordinates.
     *
    ...
    /**
     * Returns a normalized version of this vector. If the vector is zero based, a zero vector is returned.
     *
    ...
    /**
     * Calculates the midpoint between this vector and the vector with the given x and y coordinates.
     *
     * @param x the x coordinate of the other vector
     * @param y the y coordinate of the other vector
     ...
     * @return a new vector representing the result of rotating this vector by the specified angle
     */
    @CheckReturnValue
    @Nonnull
