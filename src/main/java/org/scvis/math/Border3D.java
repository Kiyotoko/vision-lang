...
/**
 * The Border3D interface represents a 3D border or shape in geometry. It provides methods for containment,
 * intersection, translation, rotation, and obtaining the centroid.
 *
 * @author karlz
 */
public interface Border3D<B extends Border3D<B>> extends Serializable {
    /**
     ...
     */
    @CheckReturnValue
    boolean intersects(@Nonnull B border3D);

    /**
     * Translates the border by the specified translation values along the x, y, and z axes.
     *
    ...
    @CheckReturnValue
    @Nonnull
    B translate(double x, double y, double z);
    ...
    @CheckReturnValue
    @Nonnull
    default B translate(@Nonnull Point3D v) {
        return translate(v.getX(), v.getY(), v.getZ());
    }

    /**
     * Rotates the border around the specified center point by the specified angles in radians.
     *
    ...
    @CheckReturnValue
    @Nonnull
    B rotate(@Nonnull Point3D center, double a, double b);
    ...
    @CheckReturnValue
    @Nonnull
    default B rotate(double a, double b) {
